...
class SeccionPruebas extends Component {
    ...
    */
    ...
    sumar(){
        //this.contador++ NO
        //this.contador= this.contador + 1 NO
        //this.state.contador = this.state.contador + 1 NO
        this.setState({
    ...
    render() {
        ...
        return (
            <section id="content">
                ...
                <p>
                    <input type="button" onClick={this.sumar.bind(this)} value="+"/> {/* el bild es necesario para el stado */}
                    <input type="button" onClick={this.restar.bind(this)} value="-"/>
                </p>
            </section>
        );
    }
